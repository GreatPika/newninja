...
import { updateMessageRole } from "@/utils/messages";
...
export function MessageConteiner({
  ...
  const handleRoleChange = async (id: number, newRole: string) => {
    ...
    await updateMessageRole(id, newRole);
            ...
            <CardHeader className="flex justify-between items-center">
              {isUser ? (
                ...
                message.id !== undefined && (
                  <Input
                    value={editRoles[message.id] || message.role}
                    clearable
                    underlined
                    onChange={(e) =>
                      handleInputChange(message.id as number, e.target.value)
                    }
                    onBlur={(e) => {
