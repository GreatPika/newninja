...
export default function HomePage() {
  const emptyStateMessage =
    "Все сообщения в этом чате хранятся локально в памяти вашего браузера. При очистке данных сайта вся информация будет безвозвратно удалена." +
    " Чтобы сохранить данные, рекомендуем экспортировать документы в формате Excel." +
