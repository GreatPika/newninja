...
export default function EditPage() {
  ...
  useEffect(() => {
    const updateSource = async () => {
      if (!messageId || !selectedKey) return;
      ...
      try {
        ...
        setSourceContent(convertSourceToText(message.source, selectedKey));
      } catch (error) {
        ...
        >
          <div style={{ height: "100%" }}>
            <Editor
              ...
              onColumn4Change={setSelectedKey}
            />
          </div>
        </Panel>
